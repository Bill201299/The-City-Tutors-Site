...
def setup_test(apps, schema_editor):
    ...
    subject_social_studies = Subject.objects.get(
        display="Social Studies", sector=sector_k_6
    )
    ...
    tutor_profile.offered_subjects.set([subject_social_studies])
    tutor_profile.offered_sectors.set([sector_k_6])
